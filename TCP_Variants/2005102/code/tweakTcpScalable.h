...
#ifndef TWEAKTCPSCALABLE_H
#define TWEAKTCPSCALABLE_H
...
class TweakTcpScalable : public TcpNewReno
{
  public:
    /**
     ...
     */
    TweakTcpScalable(const TweakTcpScalable& sock);
    ~TweakTcpScalable() override;
  ...
  private:
    ...
    uint32_t m_aiFactor; //!< Additive increase factor  //determining how much the congestion window is incremented
    double m_mdFactor;   //!< Multiplicative decrease factor   //determining how much the congestion window is decreased upon congestion detection.
};

} // namespace ns3

#endif // TWEAKTCPSCALABLE_H
